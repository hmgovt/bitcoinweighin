"""Gold Good Delivery Single — FINAL production render.

Locked v3 settings with 512 samples. Renders main sprite + contact shadow.
Saves .blend source file.
"""
import bpy
import math
import os
...
OUTPUT_SHADOW = os.path.join(PROJECT, "static/sprites/gold/good_delivery_single-shadow@2x.png")
...
# Add shadow catcher ground plane
...
print("DONE: good_delivery_single final")
