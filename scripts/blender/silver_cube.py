...
# Macro roughness variation — tightened to 0.05–0.12 for mirror polish
# (gold sat at 0.15–0.28 to read as cast). Without this band the surface
# looks like a perfect mirror and reads as plastic at thumbnail size.
