import type { HeaderSource } from '../../src/lib/mining/sha256.ts';

/** Two real, consecutive blocks with known field values — stable fixtures for parser tests. */
export const FIXTURE_BLOCKS: HeaderSource[] = [
	{
		height: 968389,
		header:
